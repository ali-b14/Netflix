...
import com.bodleian.service.mapper.VideoMetaDataMapper;
...
class VideoMetaDataResourceIT {
    ...
    public static VideoMetaData createEntity(EntityManager em) {
        VideoMetaData videoMetaData = new VideoMetaData().type(DEFAULT_TYPE).description(DEFAULT_DESCRIPTION);
    ...
    public static VideoMetaData createUpdatedEntity(EntityManager em) {
        VideoMetaData videoMetaData = new VideoMetaData().type(UPDATED_TYPE).description(UPDATED_DESCRIPTION);
        return videoMetaData;
    }
    ...
    void putExistingVideoMetaData() throws Exception {
        ...
        updatedVideoMetaData.type(UPDATED_TYPE).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateVideoMetaDataWithPatch() throws Exception {
        ...
        partialUpdatedVideoMetaData.type(UPDATED_TYPE).description(UPDATED_DESCRIPTION);
