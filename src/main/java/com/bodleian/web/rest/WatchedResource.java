...
import com.bodleian.repository.WatchedRepository;
import com.bodleian.service.WatchedService;
...
/**
 * REST controller for managing {@link com.bodleian.domain.Watched}.
 */
@RestController
...
public class WatchedResource {
    ...
    public ResponseEntity<WatchedDTO> createWatched(@Valid @RequestBody WatchedDTO watchedDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/watcheds/" + watchedDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, watchedDTO.getId().toString()))
            .body(watchedDTO);
    }
    ...
    public ResponseEntity<WatchedDTO> updateWatched(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, watchedDTO.getId().toString()))
            .body(watchedDTO);
    }
    ...
    public ResponseEntity<WatchedDTO> partialUpdateWatched(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, watchedDTO.getId().toString())
        );
    }
