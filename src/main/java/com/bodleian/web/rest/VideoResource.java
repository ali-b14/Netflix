...
import com.bodleian.service.VideoService;
...
/**
 * REST controller for managing {@link com.bodleian.domain.Video}.
 */
@RestController
...
public class VideoResource {
    ...
    public ResponseEntity<VideoDTO> createVideo(@Valid @RequestBody VideoDTO videoDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/videos/" + videoDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, videoDTO.getId().toString()))
            .body(videoDTO);
    }
