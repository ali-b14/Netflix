...
import com.bodleian.repository.WatchLaterRepository;
import com.bodleian.service.WatchLaterService;
...
/**
 * REST controller for managing {@link com.bodleian.domain.WatchLater}.
 */
@RestController
...
public class WatchLaterResource {
    ...
    public ResponseEntity<WatchLaterDTO> createWatchLater(@RequestBody WatchLaterDTO watchLaterDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/watch-laters/" + watchLaterDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, watchLaterDTO.getId().toString()))
            .body(watchLaterDTO);
    }
    ...
    public ResponseEntity<WatchLaterDTO> updateWatchLater(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, watchLaterDTO.getId().toString()))
            .body(watchLaterDTO);
    }
    ...
    public ResponseEntity<WatchLaterDTO> partialUpdateWatchLater(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, watchLaterDTO.getId().toString())
        );
    }
