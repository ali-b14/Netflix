...
import com.bodleian.repository.LikeRepository;
import com.bodleian.service.LikeService;
...
/**
 * REST controller for managing {@link com.bodleian.domain.Like}.
 */
@RestController
...
public class LikeResource {
    ...
    public ResponseEntity<LikeDTO> createLike(@Valid @RequestBody LikeDTO likeDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/likes/" + likeDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, likeDTO.getId().toString()))
            .body(likeDTO);
    }
    ...
    public ResponseEntity<LikeDTO> partialUpdateLike(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, likeDTO.getId().toString())
        );
    }
