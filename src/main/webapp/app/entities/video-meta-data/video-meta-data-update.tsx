  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="netflixCopyApp.videoMetaData.home.createOrEditLabel" data-cy="VideoMetaDataCreateUpdateHeading">
            Create or edit a Video Meta Data
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField name="id" required readOnly id="video-meta-data-id" label="ID" validate={{ required: true }} />
              ) : null}
              <ValidatedField label="Type" id="video-meta-data-type" name="type" data-cy="type" type="text" />
              <ValidatedField label="Description" id="video-meta-data-description" name="description" data-cy="description" type="text" />
